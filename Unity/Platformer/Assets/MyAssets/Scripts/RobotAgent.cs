...
public class RobotAgent : Agent
{
    ...
    public override void AgentAction(float[] vectorAction, string textAction)
    {
        ...
        float lBoundX = playArea.transform.position.x - playArea.length / 2 + playArea.agentX;
        float rBoundX = playArea.transform.position.x + playArea.length / 2 - playArea.agentX;
